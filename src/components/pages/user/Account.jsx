...
const Account = () => {
    return (
        <div className="max-w-xl mx-auto p-6">
            ...
            {/* user Info */}
            <div className="my-4 w-23 text-center items-center px-1 py-1 rounded-lg font-semibold text-gray-700 bg-[#D9D9D9]">User Info</div>
            ...
            {/* contact Info */}
            <div className="mt-5 my-4 w-30 text-center items-center px-1 py-1 rounded-lg font-semibold text-gray-700 bg-[#D9D9D9]">Contact Info</div>
            <div className="mb-4 ml-2">

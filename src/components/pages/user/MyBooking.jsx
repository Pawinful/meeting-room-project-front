        ...
        return (
          <div key={item._id} className="bg-white border shadow-md p-6 mb-8">
              ...
              <table className="border border-gray-400 text-center">
                ...
                <tbody>
                  <tr className="border border-gray-400">
                    <td className="border border-gray-400 px-2 py-3 text-sm">{item.customerUsername}</td>
                    <td className="border border-gray-400 px-2 py-3 text-sm">{item.bookingStatus}</td>
            ...
            <div className="flex items-center gap-4 mb-5">
              <HiUsers />
              <span className="bg-[#FED141] px-3 py-0.5 rounded-md text-sm">{item.roomSize}</span>
            </div>
            ...
            <div className="flex justify-end items-center mt-5">
              <div className="flex gap-3">
                <button className="bg-[#E2E2E2] px-4 py-1 rounded-md cursor-pointer">Edit</button>
                <button className="bg-[#C53739] text-white px-4 py-1 rounded-md cursor-pointer">Cancel</button>
              </div>
            </div>
          </div>
        );

    ...
    return (
        <div className="max-w-xl mx-auto p-6">
            ...
            <div className="mt-5">
                ...
                <input className="w-full border border-[#CECECE] p-2 mt-3 rounded-sm" type="text" />
                ...
                <input className="w-full border border-[#CECECE] p-2 mt-3 rounded-sm" type="email" />
            </div>
            ...
            <div className="flex gap-3 items-center mt-5 p-4 bg-red-100 rounded-2xl">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-sm text-[#A6A6A6]">ฉันอ่านและยอมรับเงื่อนไข</span>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-5 flex justify-end space-x-2">
                <button className="bg-[#E2E2E2] text-gray-600 px-5 py-1 rounded cursor-pointer" disabled>Close</button>
                <button className="bg-[#8A2A2B] text-white px-5 py-1 rounded cursor-pointer">Booking</button>
            </div>
        </div>
    )
}
